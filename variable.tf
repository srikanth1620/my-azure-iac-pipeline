     ...
     variable "extra_test_storage_name" {
       description = "Name of the extra test storage account"
       default     = "extrateststorage1620sri"
     }

     variable "extra_test_container_name" {
       description = "Name of the extra test Blob container"
       default     = "extra-test-container"
     }